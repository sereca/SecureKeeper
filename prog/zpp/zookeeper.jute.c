...
int serialize_StatPersisted(struct oarchive *out, const char *tag,
		struct StatPersisted *v) {
	int rc;
...
int deserialize_StatPersisted(struct iarchive *in, const char *tag,
		struct StatPersisted *v) {
	int rc;
...
int serialize_ConnectRequest(struct oarchive *out, const char *tag,
		struct ConnectRequest *v) {
	int rc;

	rc = out->start_record(out, tag);
	rc = rc ?
			rc :
			out->serialize_Int(out, "protocolVersion", &v->protocolVersion);
...
int deserialize_ConnectRequest(struct iarchive *in, const char *tag,
		struct ConnectRequest *v) {
	int rc;
	...
	rc = rc ?
			rc :
			in->deserialize_Int(in, "protocolVersion", &v->protocolVersion);
...
int serialize_ConnectResponse(struct oarchive *out, const char *tag,
		struct ConnectResponse *v) {
	int rc;
...
int deserialize_ConnectResponse(struct iarchive *in, const char *tag,
		struct ConnectResponse *v) {
	int rc;
...
int deserialize_String_vector(struct iarchive *in, const char *tag,
		struct String_vector *v) {
	int rc = 0;
	int32_t i;
...
int deserialize_SetWatches(struct iarchive *in, const char *tag,
		struct SetWatches *v) {
	int rc;
	...
	rc = rc ?
			rc :
			deserialize_String_vector(in, "existWatches", &v->existWatches);
	rc = rc ?
			rc :
			deserialize_String_vector(in, "childWatches", &v->childWatches);
	rc = rc ? rc : in->end_record(in, tag);
	return rc;
}
...
int serialize_RequestHeader(struct oarchive *out, const char *tag,
		struct RequestHeader *v) {
	int rc;
...
int deserialize_RequestHeader(struct iarchive *in, const char *tag,
		struct RequestHeader *v) {
	int rc;
...
int serialize_MultiHeader(struct oarchive *out, const char *tag,
		struct MultiHeader *v) {
	int rc;
...
int deserialize_MultiHeader(struct iarchive *in, const char *tag,
		struct MultiHeader *v) {
	int rc;
...
int deserialize_AuthPacket(struct iarchive *in, const char *tag,
		struct AuthPacket *v) {
	int rc;
...
int serialize_ReplyHeader(struct oarchive *out, const char *tag,
		struct ReplyHeader *v) {
	int rc;
...
int deserialize_ReplyHeader(struct iarchive *in, const char *tag,
		struct ReplyHeader *v) {
	int rc;
...
int serialize_GetDataRequest(struct oarchive *out, const char *tag,
		struct GetDataRequest *v) {
	int rc;
...
int deserialize_GetDataRequest(struct iarchive *in, const char *tag,
		struct GetDataRequest *v) {
	int rc;
...
int serialize_SetDataRequest(struct oarchive *out, const char *tag,
		struct SetDataRequest *v) {
	int rc;
...
int deserialize_SetDataRequest(struct iarchive *in, const char *tag,
		struct SetDataRequest *v) {
	int rc;
...
int serialize_ReconfigRequest(struct oarchive *out, const char *tag,
		struct ReconfigRequest *v) {
	int rc;

	rc = out->start_record(out, tag);
	rc = rc ?
			rc :
			out->serialize_String(out, "joiningServers", &v->joiningServers);
	rc = rc ?
			rc :
			out->serialize_String(out, "leavingServers", &v->leavingServers);
...
int deserialize_ReconfigRequest(struct iarchive *in, const char *tag,
		struct ReconfigRequest *v) {
	int rc;
	...
	rc = rc ?
			rc :
			in->deserialize_String(in, "joiningServers", &v->joiningServers);
	rc = rc ?
			rc :
			in->deserialize_String(in, "leavingServers", &v->leavingServers);
...
int serialize_SetDataResponse(struct oarchive *out, const char *tag,
		struct SetDataResponse *v) {
	int rc;
...
int deserialize_SetDataResponse(struct iarchive *in, const char *tag,
		struct SetDataResponse *v) {
	int rc;
...
int serialize_GetSASLRequest(struct oarchive *out, const char *tag,
		struct GetSASLRequest *v) {
	int rc;
...
int deserialize_GetSASLRequest(struct iarchive *in, const char *tag,
		struct GetSASLRequest *v) {
	int rc;
...
int serialize_SetSASLRequest(struct oarchive *out, const char *tag,
		struct SetSASLRequest *v) {
	int rc;
...
int deserialize_SetSASLRequest(struct iarchive *in, const char *tag,
		struct SetSASLRequest *v) {
	int rc;
...
int serialize_SetSASLResponse(struct oarchive *out, const char *tag,
		struct SetSASLResponse *v) {
	int rc;
...
int deserialize_SetSASLResponse(struct iarchive *in, const char *tag,
		struct SetSASLResponse *v) {
	int rc;
...
int deserialize_ACL_vector(struct iarchive *in, const char *tag,
		struct ACL_vector *v) {
	int rc = 0;
	int32_t i;
...
int serialize_CreateRequest(struct oarchive *out, const char *tag,
		struct CreateRequest *v) {
	int rc;
...
int deserialize_CreateRequest(struct iarchive *in, const char *tag,
		struct CreateRequest *v) {
	int rc;
...
int serialize_Create2Request(struct oarchive *out, const char *tag,
		struct Create2Request *v) {
	int rc;
...
int deserialize_Create2Request(struct iarchive *in, const char *tag,
		struct Create2Request *v) {
	int rc;
...
int serialize_DeleteRequest(struct oarchive *out, const char *tag,
		struct DeleteRequest *v) {
	int rc;
...
int deserialize_DeleteRequest(struct iarchive *in, const char *tag,
		struct DeleteRequest *v) {
	int rc;
...
int serialize_GetChildrenRequest(struct oarchive *out, const char *tag,
		struct GetChildrenRequest *v) {
	int rc;
...
int deserialize_GetChildrenRequest(struct iarchive *in, const char *tag,
		struct GetChildrenRequest *v) {
	int rc;
...
int serialize_GetChildren2Request(struct oarchive *out, const char *tag,
		struct GetChildren2Request *v) {
	int rc;
...
int deserialize_GetChildren2Request(struct iarchive *in, const char *tag,
		struct GetChildren2Request *v) {
	int rc;
...
int serialize_CheckVersionRequest(struct oarchive *out, const char *tag,
		struct CheckVersionRequest *v) {
	int rc;
...
int deserialize_CheckVersionRequest(struct iarchive *in, const char *tag,
		struct CheckVersionRequest *v) {
	int rc;
...
int serialize_GetMaxChildrenRequest(struct oarchive *out, const char *tag,
		struct GetMaxChildrenRequest *v) {
	int rc;
...
int deserialize_GetMaxChildrenRequest(struct iarchive *in, const char *tag,
		struct GetMaxChildrenRequest *v) {
	int rc;
...
int serialize_GetMaxChildrenResponse(struct oarchive *out, const char *tag,
...
int serialize_SetMaxChildrenRequest(struct oarchive *out, const char *tag,
		struct SetMaxChildrenRequest *v) {
	int rc;
...
int deserialize_SetMaxChildrenRequest(struct iarchive *in, const char *tag,
		struct SetMaxChildrenRequest *v) {
	int rc;
...
int serialize_SyncRequest(struct oarchive *out, const char *tag,
		struct SyncRequest *v) {
	int rc;
...
int deserialize_SyncRequest(struct iarchive *in, const char *tag,
		struct SyncRequest *v) {
	int rc;
...
int serialize_SyncResponse(struct oarchive *out, const char *tag,
		struct SyncResponse *v) {
	int rc;
...
int deserialize_SyncResponse(struct iarchive *in, const char *tag,
		struct SyncResponse *v) {
	int rc;
...
int serialize_GetACLRequest(struct oarchive *out, const char *tag,
		struct GetACLRequest *v) {
	int rc;
...
int deserialize_GetACLRequest(struct iarchive *in, const char *tag,
		struct GetACLRequest *v) {
	int rc;
...
int serialize_SetACLRequest(struct oarchive *out, const char *tag,
		struct SetACLRequest *v) {
	int rc;
...
int deserialize_SetACLRequest(struct iarchive *in, const char *tag,
		struct SetACLRequest *v) {
	int rc;
...
int serialize_SetACLResponse(struct oarchive *out, const char *tag,
		struct SetACLResponse *v) {
	int rc;
...
int deserialize_SetACLResponse(struct iarchive *in, const char *tag,
		struct SetACLResponse *v) {
	int rc;
...
int serialize_WatcherEvent(struct oarchive *out, const char *tag,
		struct WatcherEvent *v) {
	int rc;
...
int deserialize_WatcherEvent(struct iarchive *in, const char *tag,
		struct WatcherEvent *v) {
	int rc;
...
int serialize_ErrorResponse(struct oarchive *out, const char *tag,
		struct ErrorResponse *v) {
	int rc;
...
int deserialize_ErrorResponse(struct iarchive *in, const char *tag,
		struct ErrorResponse *v) {
	int rc;
...
int serialize_CreateResponse(struct oarchive *out, const char *tag,
		struct CreateResponse *v) {
	int rc;
...
int deserialize_CreateResponse(struct iarchive *in, const char *tag,
		struct CreateResponse *v) {
	int rc;
...
int serialize_Create2Response(struct oarchive *out, const char *tag,
		struct Create2Response *v) {
	int rc;
...
int deserialize_Create2Response(struct iarchive *in, const char *tag,
		struct Create2Response *v) {
	int rc;
...
int serialize_ExistsRequest(struct oarchive *out, const char *tag,
		struct ExistsRequest *v) {
	int rc;
...
int deserialize_ExistsRequest(struct iarchive *in, const char *tag,
		struct ExistsRequest *v) {
	int rc;
...
int serialize_ExistsResponse(struct oarchive *out, const char *tag,
		struct ExistsResponse *v) {
	int rc;
...
int deserialize_ExistsResponse(struct iarchive *in, const char *tag,
		struct ExistsResponse *v) {
	int rc;
...
int serialize_GetDataResponse(struct oarchive *out, const char *tag,
		struct GetDataResponse *v) {
	int rc;
...
int deserialize_GetDataResponse(struct iarchive *in, const char *tag,
		struct GetDataResponse *v) {
	int rc;
...
int serialize_GetChildrenResponse(struct oarchive *out, const char *tag,
		struct GetChildrenResponse *v) {
	int rc;
...
int deserialize_GetChildrenResponse(struct iarchive *in, const char *tag,
		struct GetChildrenResponse *v) {
	int rc;
...
int serialize_GetChildren2Response(struct oarchive *out, const char *tag,
		struct GetChildren2Response *v) {
	int rc;
...
int deserialize_GetChildren2Response(struct iarchive *in, const char *tag,
		struct GetChildren2Response *v) {
	int rc;
...
int serialize_GetACLResponse(struct oarchive *out, const char *tag,
		struct GetACLResponse *v) {
	int rc;
...
int deserialize_GetACLResponse(struct iarchive *in, const char *tag,
		struct GetACLResponse *v) {
	int rc;
...
int serialize_RemoveWatchesRequest(struct oarchive *out, const char *tag,
		struct RemoveWatchesRequest *v) {
	int rc;
...
int deserialize_RemoveWatchesRequest(struct iarchive *in, const char *tag,
		struct RemoveWatchesRequest *v) {
	int rc;
...
int deserialize_LearnerInfo(struct iarchive *in, const char *tag,
		struct LearnerInfo *v) {
	int rc;
...
int deserialize_Id_vector(struct iarchive *in, const char *tag,
		struct Id_vector *v) {
	int rc = 0;
	int32_t i;
...
int serialize_QuorumPacket(struct oarchive *out, const char *tag,
		struct QuorumPacket *v) {
	int rc;
...
int deserialize_QuorumPacket(struct iarchive *in, const char *tag,
		struct QuorumPacket *v) {
	int rc;
...
int serialize_FileHeader(struct oarchive *out, const char *tag,
		struct FileHeader *v) {
	int rc;
...
int deserialize_FileHeader(struct iarchive *in, const char *tag,
		struct FileHeader *v) {
	int rc;
...
int serialize_TxnHeader(struct oarchive *out, const char *tag,
		struct TxnHeader *v) {
	int rc;
...
int deserialize_TxnHeader(struct iarchive *in, const char *tag,
		struct TxnHeader *v) {
	int rc;
...
int serialize_CreateTxnV0(struct oarchive *out, const char *tag,
		struct CreateTxnV0 *v) {
	int rc;
...
int deserialize_CreateTxnV0(struct iarchive *in, const char *tag,
		struct CreateTxnV0 *v) {
	int rc;
...
int serialize_CreateTxn(struct oarchive *out, const char *tag,
	...
	rc = rc ? rc : out->serialize_Bool(out, "ephemeral", &v->ephemeral);
	rc = rc ?
			rc : out->serialize_Int(out, "parentCVersion", &v->parentCVersion);
	rc = rc ? rc : out->end_record(out, tag);
	return rc;
}

int deserialize_CreateTxn(struct iarchive *in, const char *tag,
		struct CreateTxn *v) {
	int rc;
	...
	rc = rc ? rc : in->deserialize_Bool(in, "ephemeral", &v->ephemeral);
	rc = rc ?
			rc : in->deserialize_Int(in, "parentCVersion", &v->parentCVersion);
	rc = rc ? rc : in->end_record(in, tag);
	return rc;
}
...
int serialize_DeleteTxn(struct oarchive *out, const char *tag,
		struct DeleteTxn *v) {
	int rc;
...
int deserialize_DeleteTxn(struct iarchive *in, const char *tag,
		struct DeleteTxn *v) {
	int rc;
...
int serialize_SetDataTxn(struct oarchive *out, const char *tag,
		struct SetDataTxn *v) {
	int rc;
...
int deserialize_SetDataTxn(struct iarchive *in, const char *tag,
		struct SetDataTxn *v) {
	int rc;
...
int serialize_CheckVersionTxn(struct oarchive *out, const char *tag,
		struct CheckVersionTxn *v) {
	int rc;
...
int deserialize_CheckVersionTxn(struct iarchive *in, const char *tag,
		struct CheckVersionTxn *v) {
	int rc;
...
int serialize_SetACLTxn(struct oarchive *out, const char *tag,
		struct SetACLTxn *v) {
	int rc;
...
int deserialize_SetACLTxn(struct iarchive *in, const char *tag,
		struct SetACLTxn *v) {
	int rc;
...
int serialize_SetMaxChildrenTxn(struct oarchive *out, const char *tag,
		struct SetMaxChildrenTxn *v) {
	int rc;
...
int deserialize_SetMaxChildrenTxn(struct iarchive *in, const char *tag,
		struct SetMaxChildrenTxn *v) {
	int rc;
...
int serialize_CreateSessionTxn(struct oarchive *out, const char *tag,
		struct CreateSessionTxn *v) {
	int rc;
...
int deserialize_CreateSessionTxn(struct iarchive *in, const char *tag,
		struct CreateSessionTxn *v) {
	int rc;
...
int serialize_ErrorTxn(struct oarchive *out, const char *tag,
		struct ErrorTxn *v) {
	int rc;
...
int deserialize_ErrorTxn(struct iarchive *in, const char *tag,
		struct ErrorTxn *v) {
	int rc;
...
int serialize_Txn_vector(struct oarchive *out, const char *tag,
		struct Txn_vector *v) {
	int32_t count = v->count;
	int rc = 0;
	int32_t i;
...
int deserialize_Txn_vector(struct iarchive *in, const char *tag,
		struct Txn_vector *v) {
	int rc = 0;
	int32_t i;
...
int serialize_MultiTxn(struct oarchive *out, const char *tag,
		struct MultiTxn *v) {
	int rc;
...
int deserialize_MultiTxn(struct iarchive *in, const char *tag,
		struct MultiTxn *v) {
	int rc;
